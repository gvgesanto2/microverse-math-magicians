...
describe('HamburgerMenu component', () => {
  ...
  it('should navigate to the calculator and close the menu page when clicking the calculator navigation link', () => {
    const CalculatorNavLink = screen.getByRole('link', { name: /02 calculator/i });
  ...
  it('should navigate to the quote page and close the menu when clicking the quote navigation link', () => {
    const QuoteNavLink = screen.getByRole('link', { name: /03 quote/i });
